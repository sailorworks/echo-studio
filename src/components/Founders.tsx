...
// Simple inline SVG for Instagram Logo (Remains the same)
// Simple inline SVG for Instagram Logo (Corrected)
...
const Founders = () => {
  ...
  return (
    <motion.section
      ref={sectionRef}
      // ** ADDED POINTER-EVENTS-NONE to the section wrapper **
    ...
    >
      ...
      {/* Centered Title Container (z-10) - Make non-interactive */}
      <motion.div
        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10 px-6 text-center pointer-events-none"
        initial={{ y: 50, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
        transition={{ duration: 0.8, delay: 0.3 }}
      ></motion.div>

      {/* Bottom Left Links Container (z-40) - Explicitly ENABLE pointer events */}
      <motion.div
        // ** ENSURE POINTER-EVENTS-AUTO IS HERE **
        className="absolute bottom-40 left-20 z-40 flex flex-row items-center gap-6 md:gap-8 pointer-events-auto"
